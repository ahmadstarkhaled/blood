        ...
        <div class="row">
            <div class="col-lg-12">
				 <h3 class=" text-primary">
					<i class='fa fa-heart'></i>  خوێن بەخشین بۆ ژیان رزگارکردن
                </h3><hr>
            </div>
        </div>
		    ...
		    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
                <div class="panel panel-primary">
					...
					<form autocomplete="off" method="post"  action="<?php echo $_SERVER['PHP_SELF'];?>" enctype="multipart/form-data">
						...
						<div class="form-group">
							<label class="control-label text-primary">گرووپی خوێن</label>
						...
						<div class="form-group">
						   ...
						   <div class="form-group">
							<button class="btn btn-primary" id="BTN" name="submit"><i class="fa fa-send"></i> ناردن</button>
						  </div>
						 </form>
                    </div>
                </div>
